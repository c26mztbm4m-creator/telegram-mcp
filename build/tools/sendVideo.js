    ...
    async run(args) {
        try {
            ...
            if (validatedArgs.duration)
                options.duration = validatedArgs.duration;
            if (validatedArgs.width)
                options.width = validatedArgs.width;
            if (validatedArgs.height)
                options.height = validatedArgs.height;
            ...
            if (validatedArgs.supportsStreaming)
                options.supports_streaming = validatedArgs.supportsStreaming;
